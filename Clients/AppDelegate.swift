...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func initializeData() {
        ...
        let golova = Client(photoData: UIImage(named: "golova")!.pngData(), surname: "Голова", name: "Мария", phonenumber: "79272105059", vk: "https://vk.com/mariyagolova", notes: "Мария Костюшкина", isBlocked: true)
        _ = Client(photoData: UIImage(named: "dulikov")!.pngData(), surname: "Дуликов", name: "Григорий", phonenumber: "79272155559", vk: "", notes: "Ветеренар. Учился в Самарском Государственном Аграрном Университете. Любит кастрировать котов.")
        _ = Client(photoData: UIImage(named: "dunyashin")!.pngData(), surname: "Дуняшин", name: "Егор", vk: "https://vk.com/e.dunyashin", notes: "Староста")
        _ = Client(photoData: UIImage(named: "dunyushkin")!.pngData(), surname: "Дунюшкин", name: "Николай", phonenumber: "79277199264", vk: "https://vk.com/reitars9", notes: "Член клуба любителей Toyota Corolla")
        _ = Client(photoData: UIImage(named: "golov")!.pngData(), surname: "Голов", name: "Максим", phonenumber: "79277004591", vk: "https://vk.com/afterfocus")
        _ = Client(photoData: UIImage(named: "holin")!.pngData(), surname: "Холин", name: "Данил", vk: "https://vk.com/id28793961")
        _ = Client(photoData: UIImage(named: "korcev")!.pngData(), surname: "Корцев", name: "Матвей", phonenumber: "79377938873", vk: "https://vk.com/ytom63")
        let kostyushkina = Client(photoData: UIImage(named: "kostyushkina")!.pngData(), surname: "Костюшкина", name: "Мария", phonenumber: "79370752426", vk: "https://vk.com/id147563704")
        let peshnova = Client(photoData: UIImage(named: "peshnova")!.pngData(), surname: "Пешнова", name: "Елизавета", phonenumber: "79277355555", vk: "https://vk.com/liza.peshnova")
        let trots = Client(photoData: UIImage(named: "trots")!.pngData(), surname: "Троц", name: "Виктория", phonenumber: "79171061906", vk: "https://vk.com/id151942419")
        let fedorova = Client(photoData: UIImage(named: "fedorova")!.pngData(), surname: "Фёдорова", name: "Дарья", phonenumber: "79170391315", vk: "https://vk.com/luckrose")
        _ = Client(photoData: nil, surname: "Хван", name: "Кира")
        let egorova = Client(photoData: UIImage(named: "egorova")!.pngData(), surname: "Александровна", name: "Настасья", vk: "https://vk.com/idnastasia16")
        let petrova = Client(photoData: UIImage(named: "petrova")!.pngData(), surname: "Петрова", name: "Ирина", vk: "https://vk.com/id136672421")
        let kirillova = Client(photoData: UIImage(named: "kirillova")!.pngData(), surname: "Кириллова", name: "Екатерина", phonenumber: "79277655010", vk: "https://vk.com/id7772483")
        let ilicheva = Client(photoData: UIImage(named: "ilicheva")!.pngData(), surname: "Ильичёва", name: "Кристина", vk: "https://vk.com/ilichevachris")
        let vechkileva = Client(photoData: UIImage(named: "vechkileva")!.pngData(), surname: "Вечкилёва", name: "Наталья", vk: "https://vk.com/id4739933")
        let boiko = Client(photoData: UIImage(named: "boiko")!.pngData(), surname: "Бойко", name: "Надежда", vk: "https://vk.com/nadezhda.boyko83")
        let melihova = Client(photoData: UIImage(named: "melihova")!.pngData(), surname: "Мелихова", name: "Надежда", vk: "https://vk.com/2h22m")
        let gerasimova = Client(photoData: UIImage(named: "gerasimova")!.pngData(), surname: "Герасимова", name: "Наталья", phonenumber: "79372004373", vk: "https://vk.com/olmeknat")
        let olgina = Client(photoData: UIImage(named: "olgina")!.pngData(), surname: "Ольгина", name: "Ольга", vk: "https://vk.com/id113639246")
        let sergeeva = Client(photoData: UIImage(named: "sergeeva")!.pngData(), surname: "Сергеева", name: "Екатерина", vk: "https://vk.com/id93326504")
        let osipova = Client(photoData: UIImage(named: "osipova")!.pngData(), surname: "Осипова", name: "Яна", vk: "https://vk.com/id58112339")
